...
- использование `ostree` для обеспечения "атомарного" обновления дистрибутива;
- четкая классификация корневых директориев:
  ...
  * `/var/` - изменяемая часть - логиб домашние директории пользователей, обрабатываемые данные.
